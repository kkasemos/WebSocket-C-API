...
struct websck_frame {
  ...
  unsigned char mask;
  unsigned char plen; /* payload lenght */
  unsigned char ext_plen[MAX_EXT_PAYLOAD_LEN]; /* extended payload length */
  unsigned char mask_key[MASK_KEY_LEN];
